...
\emph{Forward reasoning} is common in mathematical exposision
\begin{itemize}
  \item start from the hypotheses
  \item use them iteratively to accumulate further usable facts
  \item conclude once enough facts are present
\end{itemize}
